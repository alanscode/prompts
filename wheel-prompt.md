# EQUITY RESEARCH REPORT FOR TICKER: [TICKER]
...
2.  **Sympathy & Correlation Scan:** Identify stocks/ETFs with > 0.85 correlation or direct sympathy (e.g., peers, major customers, suppliers). **Check their earnings dates and major events** for the next 30 days.
3.  **Macro-Economic Scan:** Identify upcoming FOMC, CPI, and Jobs reports (Next 30 days).
4.  **Fundamental Audit:** Compare asset data against Phase A criteria.
5.  **Portfolio Fit Check:** Calculate Beta and Correlation to SPY to enable "Beta-Weighted Delta" sizing.
6.  **Support Level Deep Dive:** Map VPVR, Fibs, and Gamma Walls to find the "Iron Floor."
7.  **Thesis Generation:**
...
### 1. Macro & Correlated Event Horizon (Next 30 Days)
*Identify external volatility catalysts and sympathy risks.*
* **Direct Events:** [Company Earnings/Ex-Div Date]
* **Sympathy Drivers (Peers/Customers):** [Identify top 2-3 correlated stocks/ETFs. List their earnings dates or major events. *Example: "NVDA reporting earnings on [Date] typically moves [TICKER] ±3%."*]
* **Macro Catalysts:**
...
---
**Final Analyst Note:** [Synthesize the Macro risks, Sympathy risks, Fundamental Quality, and IV-HV edge into a final verdict.]
